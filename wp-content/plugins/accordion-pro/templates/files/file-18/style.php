...
#accordion_pro_<?php echo $post_id; ?> .wpsm_panel-title > p{
    display: block !important;
	<?php if($op_cl_icon_align=="left") { ?>
    padding: 15px 30px 15px 50px !important;
	<?php } else { ?>
...
#offset_<?php echo $post_id; ?> .wpsm_panel-title > p{
	margin-bottom: 0;
	margin-top: 0;
}
#accordion_pro_<?php echo $post_id; ?> .wpsm_panel-title > p{
...
#accordion_pro_<?php echo $post_id; ?> .wpsm_panel-title > p:before{
	content: "";
	position: absolute;
    top: 0px;
	bottom: 0px;
