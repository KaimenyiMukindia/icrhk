...
while ( $loop->have_posts() ) : $loop->the_post();
	...
	#search_<?php echo $post_id; ?>.search_dark{
    background: #464646 !important;
    color: #fff !important;
	}
	#search_<?php echo $post_id; ?>.search_dark::placeholder{
		color: #d3d3d3;
	}
	...
	<div id="wps_accordion_pro_<?php echo $post_id; ?>" <?php echo defined( 'ET_CORE_VERSION' ) ? ' class="et_smooth_scroll_disabled"' : ''; ?> >
	<?php if($search_box == 'yes'){ 
	 				if($search_box_layout == 1){ ?>
							<input id="search_<?php echo $post_id; ?>" type="text" placeholder="<?php echo $search_box_placeholder ?>">
					<?php }else{ ?>
							<input id="search_<?php echo $post_id; ?>" class="search_dark" type="text" placeholder="<?php echo $search_box_placeholder ?>">
	<?php } }?>
		  <div class="noresults_<?php echo $post_id; ?> wpsm_panel-group" style="display: none;" id="accordion_pro_<?php echo $post_id; ?>" role="tablist" aria-multiselectable="true">
		  	<div class="wpsm_panel panel" id="offset_<?php echo $post_id; ?>">
					<div class="wpsm_panel-heading" role="tab" id="heading_<?php echo $post_id; ?>">
...
<script type="text/javascript">
	  ...
	  jQuery('.noresults_<?php echo $post_id; ?>').hide();
	  
	  jQuery("#search_<?php echo $post_id; ?>").on("keyup", function() {
