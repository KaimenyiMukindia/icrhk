...
if(isset($PostID) && isset($_POST['accordion_pro_setting_save_action'])) {
			...
			$search_box_layout      	= sanitize_option('search_box_layout',$_POST['search_box_layout']);
			$search_box_placeholder     = sanitize_option('search_box_placeholder',$_POST['search_box_placeholder']);
			...
			$search_box          		= sanitize_option('search_box',$_POST['search_box']);
