...
$De_Settings = unserialize(get_option('wpsm_accordion_pro_default_settings'));
 ...
 $Settings = unserialize(get_post_meta( $PostId, 'Accordion_Pro_Settings', true));
		...
		$option_names = array(
			...
			"search_box" 				=> $De_Settings['search_box'],
			...
			"search_box_layout"      		=> $De_Settings['search_box_layout'],
			"search_box_placeholder"    => $De_Settings['search_box_placeholder'],
...
if(isset($_POST['action_ac_pro']) == "updte_wpsm_ac_pro_default_settings")
	{
		...
		$Settings_Array = serialize( array(
				...
				"search_box_layout"      		=> $search_box_layout,
...
<table class="form-table acc_table">
	<tbody>
		...
		<tr>
			<th scope="row"><label><?php _e('Search Box Display',wpshopmart_accordion_pro_text_domain); ?></label>
			<a  class="ac_tooltip" href="#help" data-tooltip="#search_box_tp"><i class="fa fa-lightbulb-o"></i></a>
				</th>
			<td>
				<div class="switch">
					<input type="radio" class="switch-input" name="search_box" value="yes" id="enable_search_box" <?php if($search_box == 'yes' ) { echo "checked"; } ?>   >
					<label for="enable_search_box" class="switch-label switch-label-off"><?php _e('Yes',wpshopmart_accordion_pro_text_domain); ?></label>
					<input type="radio" class="switch-input" name="search_box" value="no" id="disable_search_box" <?php if($search_box == 'no' ) { echo "checked"; } ?> >
					<label for="disable_search_box" class="switch-label switch-label-on"><?php _e('No',wpshopmart_accordion_pro_text_domain); ?></label>
					<span class="switch-selection"></span>
				</div>
				<!-- Tooltip -->
				<div id="search_box_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Enable it if you want display search box ',wpshopmart_accordion_pro_text_domain); ?></h2>
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php _e('Search Box Layout',wpshopmart_accordion_pro_text_domain); ?></label>
				<a  class="ac_tooltip" href="#help" data-tooltip="#search_layout_tp"><i class="fa fa-lightbulb-o"></i></a>
			</th>
			<td>
				<span style="display:block;margin-bottom:10px"><input type="radio" name="search_box_layout" id="search_box_layout" value="1" <?php if($search_box_layout == '1' ) { echo "checked"; } ?> /> Light Layout </span>
				<span style="display:block;margin-bottom:10px"><input type="radio" name="search_box_layout" id="search_box_layout2" value="2" <?php if($search_box_layout == '2' ) { echo "checked"; } ?>  /> Dark Layout </span>
				<!-- Tooltip -->
				<div id="search_layout_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Select Search Box Layout',wpshopmart_accordion_pro_text_domain); ?></h2>
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php _e('Search Box Placeholder',wpshopmart_accordion_pro_text_domain); ?></label>
				<a  class="ac_tooltip" href="#help" data-tooltip="#search_placeholder_tp"><i class="fa fa-lightbulb-o"></i></a>
			</th>
			<td>
				<span style="display:block;margin-bottom:10px"><input type="text" name="search_box_placeholder" id="search_box_placeholder" value="<?php echo $search_box_placeholder; ?>" /></span>
				<!-- Tooltip -->
				<div id="search_placeholder_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Write Search Box Placeholder',wpshopmart_accordion_pro_text_domain); ?></h2>
					</div>
		    	</div>
			</td>
		</tr>
