...
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=vaskal%2ekt%40gmail%2ecom&lc=US&item_name=LogicHunt&item_number=wp&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donate_LG%2egif%3aNonHosted
Tags: logo slider, logo carousel, logo showcase, logo gallery, client logos, brand slider, partners slider, elementor logo slider, responsive logo slider, logo ticker
...
Display client logos, partner brands, sponsor badges, and affiliate logos anywhere on your WordPress site. Responsive logo carousels, grids, or flexbox layouts — no coding needed. Works with Elementor, Gutenberg, Divi, WPBakery, and any WordPress theme.

== Description ==

👉 [Live Demo](https://demo.logichunt.com/logo-slider-wp/) | [Documentation](https://docs.logichunt.com/logo-slider-wp/) | [Support](https://logichunt.com/support/) | [Get Pro](https://logichunt.com/product/wordpress-logo-slider/)

**Logo Slider WP** lets you build a logo carousel, logo grid, or flexbox brand showcase and embed it anywhere using a single shortcode. Add unlimited logos, pick your layout, and publish — in under 5 minutes.

✔ Unlimited logo showcases — no display cap
✔ Carousel, Grid & Flexbox layouts
