...
$this->meta_form->header_spacer(
    array(
        'label'   => __('<span style="color: #4c87c9; display: flex; align-items: center; gap: 6px;"><i class="dashicons dashicons-info-outline" style="font-size: 20px; color: #4c87c9;"></i> Looking for Carousel or Grid Showcase?</span>', 'logo-slider-wp'),
        'message' => __('<span style="color: #444; font-weight: 400;">You are currently viewing <strong style="color: #2ab934;">Flexbox</strong> settings. To switch to <strong style="color: #222;">Carousel</strong> or <strong style="color: #222;">Grid</strong>, select from the <strong style="color: #222;">Showcase Type</strong> dropdown at the top. ☝️</span>', 'logo-slider-wp'),
        'type'    => 'info',
    )
);
