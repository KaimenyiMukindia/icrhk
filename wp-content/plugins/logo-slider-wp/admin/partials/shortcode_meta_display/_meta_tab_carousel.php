...
$this->meta_form->header_spacer(
    array(
        'label'   => __('<span style="color: #4c87c9; display: flex; align-items: center; gap: 6px;"><i class="dashicons dashicons-info-outline" style="font-size: 20px; color: #4c87c9;"></i> Looking for Grid or Flexbox Showcase?</span>', 'logo-slider-wp'),
       'message' => __('<span style="color: #444; font-weight: 400;">You are currently viewing <strong style="color: #2ab934;">Carousel</strong> settings. To switch to <strong style="color: #222;">Flexbox</strong> or <strong style="color: #222;">Grid</strong>, select from the <strong style="color: #222;">Showcase Type</strong> dropdown at the top. ☝️</span>', 'logo-slider-wp'),
...
$this->meta_form->buy_pro([
    ...
    'text'       => '✨ Pro unlocks: Coverflow 3D effect, RTL direction, pause on hover, mouse wheel & grab cursor.',
    'link_label' => 'See Pro →',
]);
...
$this->meta_form->buy_pro(
    array(
        'status'  => LGX_LS_PLUGIN_META_FIELD_PRO,
        'link' => 'https://logichunt.com/product/wordpress-logo-slider/',
        'text'   => '✨ Pro unlocks: Dynamic bullets, hide pagination on mobile.',
        'link_label' => 'See Pro →',
    )
);
...
$this->meta_form->buy_pro(
    array(
        'status'  => LGX_LS_PLUGIN_META_FIELD_PRO,
        'link' => 'https://logichunt.com/product/wordpress-logo-slider/',
        'text'   => '✨ Pro unlocks: Auto height, mouse wheel scroll, grab cursor.',
        'link_label' => 'See Pro →',
    )
