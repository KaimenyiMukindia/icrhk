			...
			{  	
				...
				<div class="<?php echo $sb_Layout_Cls;?>">
					<div class="wpsm_serviceBox_<?php echo $PostId;?>" id="wpsm_serviceBox_<?php echo $PostId."_".$i;?>">
						<div class="wpsm_service_content serviceBox_content_<?php echo $PostId;?>">
							<?php if($sb_all_contents_btn_img_or_icon=='Icon'){?>
										<i class='wpsm_service_icon_i <?php echo $sb_all_contents_icons;?>'></i><?php } 
							else { ?>
							...
							<?php //big image
							if($sb_all_contents_btn_img_or_icon=='Icon'){?>
								<i class='<?php echo $sb_all_contents_icons;?> icon-bg'></i><?php } 
							else { ?>
								<img src='<?php echo $sb_all_contents_images;?>' style='width:110px;height:150px;' class='icon-bg' id='img_big'/><?php } ?>
					</div>
				</div>
...
{ 	?>
	...
	var col = new jColumn();
	col.jcolumn('serviceBox_content_<?php echo $PostId;?>');
