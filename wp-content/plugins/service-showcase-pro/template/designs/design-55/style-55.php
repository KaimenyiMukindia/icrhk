...
.wpsm_serviceBox_<?php echo $PostId;?> .wpsm_service_content h3:after{
    ...
    margin: 15px 0;
    height: 2px;
    background: <?php echo $sb_set_title_clr;?>;
}
...
if($sb_ind_clr_enable=="yes")
{
	...
	{ 	
		...
		#wpsm_serviceBox_<?php echo $PostId."_".$k;?> .wpsm_service_content h3:after{
			background: <?php echo $sb_all_contents_title_clr;?>;
		}
