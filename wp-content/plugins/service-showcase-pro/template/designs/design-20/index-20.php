			...
			{  	
				...
				<div class="<?php echo $sb_Layout_Cls;?>">
					<div class="wpsm_serviceBox_<?php echo $PostId;?>" id="wpsm_serviceBox_<?php echo $PostId."_".$i;?>">
						<div class="wpsm_service_icon <?php echo $var_img_service_icon_cls;?>" >
						...
						<div class="wpsm_service_content">	
							<h3 class="wpsm_title"><span><?php $arr=explode(" ",trim($sb_all_contents_title)); echo $arr[0];?></span><?php for($counter=1;$counter<count($arr);$counter++){echo "</br>". $arr[$counter];}?></h3>
