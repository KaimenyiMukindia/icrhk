...
$font_family=$sb_set_font_family;?>
<select name="font_family" id="font_family" class="standard-dropdown" onchange="get_font_type_group()"  style="width:100%" >
...
<script> 		
function get_font_type_group()
{
	var family_group = jQuery('#font_family option:selected').closest('optgroup').prop('label');
	var font_type = jQuery('#font_family option:selected').val();
	 
	 jQuery("#sb_set_font_family_grp").val(family_group);
	 jQuery("#sb_set_font_family").val(font_type);
}
