    ...
    protected function woocommerce_wp_text_input($i, $tab) {
        ...
        woocommerce_wp_text_input(
                array(
                    ...
                    'label' => __('Tab Title', wpshopmart_tabs_pro_text_domain),
                    'description' => '',
                    'value' => isset($tab['title']) ? $tab['title'] : 'Tabs Title',
                    'placeholder' => __('Tab Title', wpshopmart_tabs_pro_text_domain),
        ...
        woocommerce_wp_text_input(
                array(
                    ...
                    'label' => __('Tab Icon', wpshopmart_tabs_pro_text_domain),
                    'description' => '',
                    'value' => isset($tab['icon']) ? $tab['icon'] : 'fas fa-table',
                    'placeholder' => __('Tab Icon', wpshopmart_tabs_pro_text_domain),
        ...
        woocommerce_wp_text_input(
                array(
                    ...
                    'label' => __('Tab Priority', wpshopmart_tabs_pro_text_domain),
                    'description' => '',
                    'value' => isset($tab['priority']) ? $tab['priority'] : 0,
                    'placeholder' => __('Tabs Priority', wpshopmart_tabs_pro_text_domain),
        ...
        woocommerce_wp_text_input(
                array(
                    ...
                    'label' => __('Callback Function', wpshopmart_tabs_pro_text_domain),
                    'description' => '',
                    'value' => isset($tab['callback']) ? $tab['callback'] : '',
                    'placeholder' => __('Add callback function else make it blank', wpshopmart_tabs_pro_text_domain),
