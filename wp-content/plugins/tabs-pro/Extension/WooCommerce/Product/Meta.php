    ...
    public function enqueue_scripts_and_styles($hook) {
        ...
        if ($hook === 'post-new.php' || $hook === 'post.php') {
            if (isset($post->post_type) && $post->post_type === 'product') {
                ...
                wp_enqueue_style('responsive_tabs_woo-styles', RESPONSIVE_TABS_PRO_URL . 'Extension/WooCommerce/assets/woocommerce/css/admin.css', false, RESPONSIVE_TABS_PRO_PLUGIN_VERSION);
                wp_enqueue_script('responsive_tabs_woo_admin', RESPONSIVE_TABS_PRO_URL . 'Extension/WooCommerce/assets/woocommerce/js/admin.js', false, RESPONSIVE_TABS_PRO_PLUGIN_VERSION);
                wp_enqueue_style('font-awsome.min', RESPONSIVE_TABS_PRO_URL . 'Extension/WooCommerce/assets/frontend/css/font-awsome.min.css', false, RESPONSIVE_TABS_PRO_PLUGIN_VERSION);
                wp_enqueue_style('fontawesome-iconpicker', RESPONSIVE_TABS_PRO_URL . 'Extension/WooCommerce/assets/backend/css/fontawesome-iconpicker.css', false, RESPONSIVE_TABS_PRO_PLUGIN_VERSION);
                wp_enqueue_script('fontawesome-iconpicker', RESPONSIVE_TABS_PRO_URL . 'Extension/WooCommerce/assets/backend/js/fontawesome-iconpicker.js', false, RESPONSIVE_TABS_PRO_PLUGIN_VERSION);
                wp_enqueue_script('iconpicker', RESPONSIVE_TABS_PRO_URL . 'Extension/WooCommerce/assets/js/iconpicker.js', array('jquery'), true, RESPONSIVE_TABS_PRO_PLUGIN_VERSION);
            }
        }
    }
    ...
    public function add_product_panels() {
        ...
        <div id="responsive_tabs_product_data" class="panel woocommerce_options_panel">
            ...
            woocommerce_wp_select(array(
                ...
                'label' => __('Select Tabs Layots', wpshopmart_tabs_pro_text_domain),
                'description' => __('Select Layouts which ', wpshopmart_tabs_pro_text_domain),
                'desc_tip' => true,
            ));
