...
.wpsm_tab_<?php echo $post_id; ?> .wpsm_nav-tabs li a{
	...
	border-radius: 0;
	border: none;
	border-left: 5px solid <?php echo $tabs_btn_border_color; ?>;
	margin: 0;
	padding: 15px 15px;
	position: relative;
...
.wpsm_tab_<?php echo $post_id; ?> .wpsm_nav-tabs li a:hover{
	...
	border-left-color: <?php echo $tabs_btn_border_color; ?>;
}
...
.wpsm_tab_<?php echo $post_id; ?> .wpsm_nav-tabs li.active a:hover{
	...
	color: <?php echo $select_tabs_title_clr; ?> !important;
	border: none;
	border-left: 5px solid <?php echo $select_tabs_btn_border_color; ?>;
}
