	...
	<div class="wpsm_tab_<?php echo $post_id; ?>"  role="tabpanel">
		...
		<ul class="wpsm_nav wpsm_nav-tabs" role="tablist" id="myTab_<?php echo $post_id; ?>">
			<?php foreach($tabs_data as $single_data)
			{
				...
				?>                 
				<li role="presentation" class="<?php if($i==$tabs_number){ echo "active"; } ?>">
...
<script>
	jQuery(document).ready(function(){
		...
		//alert(li_border);
		var my_style='.wpsm_tab_<?php echo $post_id; ?> .wpsm_nav-tabs li.active a:after,'+
					 '.wpsm_tab_<?php echo $post_id; ?> .wpsm_nav-tabs li a:after{'+
							...
							'top: 0;'+
							'bottom:0;'+
							'<?php echo $border_opp_side; ?>: -'+li_margin+ 'px !important;'+
							'z-index:1;'+
					  '}'+
					  ...
					  '.wpsm_tab_<?php echo $post_id; ?> .wpsm_nav-tabs li a:before{'+
							...
							'content: "";'+
							'position: absolute;'+
							'<?php echo $border_opp_side; ?>: -'+(li_margin-2)+ 'px !important;'+
							'top: 1px;'+
							'bottom:1px;'+
							'z-index: 2;'+
						'}'+
						...
						'.wpsm_tab_<?php echo $post_id; ?> .wpsm_nav-tabs li{'+
							'margin-<?php echo $border_opp_side; ?>:'+li_height+ ' !important;'+
						'}';
