...
if ( ! class_exists( 'Envira_Gallery' ) ) :
	...
	final class Envira_Gallery {
		...
		public function beta_notice() {
			...
			echo $notices->display_inline_notice('beta_notice', false, 'Apply to our exclusive <a href="https://enviragallery.com/account/become-a-beta-tester" />Beta Test Program</a> to see new updates first!', 'sucuess', '', '', true, 0 ); // @codingStandardsIgnoreLine
		}
		/**
