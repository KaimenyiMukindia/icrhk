...
$hover_params = array(
	            array(
					...
					"description" 	=> __( 'Choose hover effect', 'ich-vc' ). ' <a target="_blank" href="http://gudh.github.io/ihover/dist/index.html">Demo</a>',
					"group" 		=> 'General',
					"value" 		=> $hoverEffects,
				),
	            array(
				...
				array(
					...
					"param_name" 	=> "title",
					"description" 	=> __( 'Write your title here', 'ich-vc' ),
					"group" 		=> 'General',
				),
				array(
					"type" 			=> "textarea",
					"heading" 		=> __( 'Description', 'ich-vc' ),
					"param_name" 	=> "desc",
					"description" 	=> __( 'Write your description here', 'ich-vc' ),
					"group" 		=> 'General',
				),
				array(
					"type" 			=> "textfield",
				...
				array(
					"type" 			=> "textfield",
					"heading" 		=> __( 'Title Font size', 'ich-vc' ),
					"param_name" 	=> "title_size",
					"description" 	=> __( 'set in pixel e.g 18px', 'ich-vc' ),
					"group" 		=> 'Settings',
				),
				array(
					"type" 			=> "textfield",
					"heading" 		=> __( 'Description Font size', 'ich-vc' ),
					"param_name" 	=> "desc_size",
					"description" 	=> __( 'set in pixel e.g 15px', 'ich-vc' ),
					"group" 		=> 'Settings',
				),
				array(
					"type" 			=> "colorpicker",
					"heading" 		=> __( 'Title Color', 'ich-vc' ),
					"param_name" 	=> "title_clr",
					"group" 		=> 'Settings',
				),
				array(
					"type" 			=> "colorpicker",
					"heading" 		=> __( 'Title Background Color', 'ich-vc' ),
					"param_name" 	=> "title_bg",
					"group" 		=> 'Settings',
				),
				array(
					"type" 			=> "colorpicker",
					"heading" 		=> __( 'Description Color', 'ich-vc' ),
					"param_name" 	=> "desc_clr",
					"group" 		=> 'Settings',
				),
				...
				array(
					...
					"description" 	=> __( 'Width of border eg: 10px.', 'ich-vc' ),
					"group" 		=> 'Settings',
				),
				array(
					"type" 			=> "dropdown",
				...
				array(
					"type" 			=> "textfeld",
					"heading" 		=> __( '', 'ich-vc' ). ' <a target="_blank" href="https://1.envato.market/L3NvO">Buy Now!</a>',
					"param_name" 	=> "hover_effectsss",
					"group" 		=> 'Pro Features',
				),
				array(
					"type" 			=> "textfeld",
					"heading" 		=> __( '=> Interactive Banners', 'ich-vc' ),
					"param_name" 	=> "hover_effectss",
					"group" 		=> 'Pro Features',
				),
				array(
					"type" 			=> "textfeld",
					"heading" 		=> __( '=> Scroll Image', 'ich-vc' ),
					"param_name" 	=> "hover_effectss",
					"group" 		=> 'Pro Features',
				),
				array(
					"type" 			=> "textfeld",
					"heading" 		=> __( '=> Flip Box Style', 'ich-vc' ),
					"param_name" 	=> "hover_effectss",
					"group" 		=> 'Pro Features',
				),
				array(
					"type" 			=> "textfeld",
					"heading" 		=> __( '=> Custom Width & Height', 'ich-vc' ),
					"param_name" 	=> "hover_effectss",
					"group" 		=> 'Pro Features',
				),
				array(
				...
				array(
					"type" 			=> "textfeld",
					"heading" 		=> __( '=> Much More Options', 'ich-vc' ),
					"param_name" 	=> "hover_effectss",
					"group" 		=> 'Pro Features',
				),
